...
class WeatherDataset(Dataset):
    def __init__(self, root_path: str="./data/data.csv", frag="train", size=None, grid_size=256):
    ...
    def __read_data__(self):
        ...
        num_grids = len(df) // self.grid_size
        data = df.values[:num_grids * self.grid_size].reshape(num_grids, self.grid_size, -1)
